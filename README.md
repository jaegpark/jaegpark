...
- 🌱 I’m currently learning SQL/Python so that I can integrate more features to my Discord Bot. 
- ⚙️ I'm proficient in `java`, `C/C++`, `arduino C`, `HTML`,  `markdown`, `CSS`, `SCSS`, `Turing`, `LaTeX`, and have experience using `YAML`, `jekyll`, `ruby`, `JavaScript`, and `liquid`.
